...
void ledController_Playerinput(int PL_Pos, CRGB PL_color) {
  ...
  for (int LED = 0; LED < NUM_LEDS; LED++) {
    ...
    if (LED <= int(1 * NUM_LEDS / 8) && LED > int(1 * NUM_LEDS / 8) && PL_Pos == 2) ledController_setcolor(LED, PL_color);  
    if (LED <= int(2 * NUM_LEDS / 8) && LED > int(2 * NUM_LEDS / 8) && PL_Pos == 3) ledController_setcolor(LED, PL_color);
    if (LED <= int(3 * NUM_LEDS / 8) && LED > int(3 * NUM_LEDS / 8) && PL_Pos == 4) ledController_setcolor(LED, PL_color);
    if (LED <= int(4 * NUM_LEDS / 8) && LED > int(4 * NUM_LEDS / 8) && PL_Pos == 5) ledController_setcolor(LED, PL_color);
    if (LED <= int(5 * NUM_LEDS / 8) && LED > int(5 * NUM_LEDS / 8) && PL_Pos == 6) ledController_setcolor(LED, PL_color);
    if (LED <= int(6 * NUM_LEDS / 8) && LED > int(6 * NUM_LEDS / 8) && PL_Pos == 7) ledController_setcolor(LED, PL_color);
